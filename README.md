#  План автоматизации формы записи на курс или консультацию по курсу "Тестировщик ПО"

## ОПИСАНИЕ ТЕСТИРОВАНИЯ:
В рамках данного задания будут проведены работы по автоматизации тестирования формы записи на курс или консультацию по курсу "Тестировщик ПО" на сайте Нетология.
...
+ Согласование графика проведения тестов;
...
**Ожидаемый результат**: Отображается сообщение "Вы успешно записались на курс наш менеджер свяжется с Вами в ближайшее время"

+ **Вариант 2**
  - Ввести в поле "Имя" в форме "Запишитесь или получите консультацию": случайное имя на кириллице с цифрами. 
  - Ввести в поле "Телефон" в форме "Запишитесь или получите консультацию": случайный телефон (11 символов).

**Ожидаемый результат**: Отображается ошибка в поле "Имя": "Должно состоять из букв". 
...
**Ожидаемый результат**: Отображается ошибка в поле "Имя": "Обязательное поле".

+ **Вариант 8**
   - Оставить поле "Имя" пустым.
   - Оставить поле "Телефон" пустым.

**Ожидаемый результат**: Отображается ошибка в полях "Имя" и "Телефон": "Обязательное поле".

+ **Вариант 9**
   - Ввести в поле "Имя" в форме "Запишитесь или получите консультацию": случайное имя на кириллице/латинице.
   - Оставить поле "Телефон" пустым.

**Ожидаемый результат**: Отображается ошибка в поле "Телефон": "Обязательное поле".

+ **Вариант 10**
   - Ввести в поле "Имя" в форме "Запишитесь или получите консультацию": случайное имя на кириллице/латинице.
   - Ввести в поле "Телефон" в форме "Запишитесь или получите консультацию": случайный телефон (менее 11 символов).
     
**Ожидаемый результат**: Отображается ошибка в поле "Телефон": "Номер в формате +9 (999) 999-99-99".
...
**Список инструментов:**
+ Intellij Idea  – для выполнения работ по автоматизации;
+ Язык программирования Java 11;
+ Библиотека Lombok для создания методов с генерацией значений Faker;
+ Библиотека Faker для генерации случайных значений для ввода в поля формы;
+ Фреймворк JUnit 5 для автоматизации тестирования;
+ Фреймворк Selenide для создания тестов по заполнению тестируемой формы на сайте Нетологии.
...
| Возможные риски    | 8 часов |
| **Итого примерно**    | **58 часов**|
